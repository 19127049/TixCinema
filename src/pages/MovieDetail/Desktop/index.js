...
import useApiThoiLuongDanhGia from "../../../util/settings/useApiThoiLuongDanhGia";
import Tap from "../Tap";
...
export default function Desktop({ movieDetailShowtimes: data }) {
  ...
  const classes = useStyles({ bannerImg: data.content?.hinhAnh });
